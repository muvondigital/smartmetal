...
async function seedPipes() {
  ...
  // Load catalogue JSON - updated path for new structure
  const catalogPath = path.join(__dirname, '..', '..', 'backend', 'src', 'db', 'seeds', 'data', 'pipe_catalog.json');
