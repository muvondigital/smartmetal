/**
 * Submitted for Approval Table Widget
 *
 * Displays quotes/RFQs pending approval in a scrollable table.
...
export function SubmittedForApprovalTableWidget() {
  ...
  const loadData = async () => {
    try {
      ...
      console.error('Failed to load submitted for approval:', err);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <Card className="flex flex-col h-full overflow-hidden">
      <div className="flex-none px-6 py-4 border-b border-slate-200 flex items-center justify-between">
        <h3 className="text-slate-900 font-semibold">Submitted for Approval</h3>
